...
export function InviteMemberModal({
  ...
  const onSubmit = async (values: InviteFormValues) => {
    setIsLoading(true);
    try {
      const response = await fetch("/api/user/invite-user", {
        method: "POST",
        headers: {
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            with instructions to join. Access permissions can be configured
            later in MCP server settings.
          </DialogDescription>
        </DialogHeader>
                ...
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value={UserType.SUPER_ADMIN}>
                        Super Admin
                      </SelectItem>
                    </SelectContent>
                  </Select>
                  <FormDescription>
                    The role determines what actions the team member can
                    perform.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
